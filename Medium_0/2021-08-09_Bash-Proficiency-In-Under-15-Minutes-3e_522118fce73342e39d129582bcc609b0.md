# 2021-08-09_Bash-Proficiency-In-Under-15-Minutes-3ec9d4e2e65
...
### [Make HTTP requests in bash with](https://egghead.io/lessons/http-make-http-requests-in-bash-with-curl) `curl`
